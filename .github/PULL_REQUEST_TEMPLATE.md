...
Describe the change and the public framework behavior it affects.

## Checks

- [ ] I ran `npm run check`.
- [ ] I ran `npm run generate:types` after schema changes, if any.
...
Add migration notes, release notes, or follow-up work if relevant.

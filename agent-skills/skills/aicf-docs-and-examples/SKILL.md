...
description:
  Update AICF public docs, quickstarts, examples, README files, API references, provider
  guides, and sample apps so they match current public contracts and implementation.
license: MIT
compatibility:
...
Guide updates to public AICF docs and examples so they are accurate, simple,
implementation-aligned, and public-safe.

## Use this skill when

- Updating README, quickstarts, API docs, provider guides, release docs, or example
  apps.
- Adding docs for changed schemas, commands, exports, providers, runtime behavior,
  governance, security, or evals.
...
- Changed public contracts, README, docs index, examples, API docs, package scripts,
  changelog, and validation commands.
- References: [docs style guide](references/docs-style-guide.md),
  [example app checklist](references/example-app-checklist.md),
  [public API docs](references/public-api-docs.md), and
  [quickstart template](references/quickstart-template.md).

## Workflow

1. Identify the public contract, command, export, schema, provider, CLI, or example that
   changed.
2. Update the smallest set of public docs and examples needed to keep the learning path
   accurate.
...
5. Keep examples synthetic, credential-free by default, and runnable or explicitly
...
Use [example README template](assets/example-readme-template.md) and
[provider guide template](assets/provider-guide-template.md) for new docs.
...
- Do not include credentials, account-specific IDs, private traces, or provider
  transport bodies.
...
Report docs/examples changed, commands run, expected output added, public-safety checks,
and remaining docs gaps.
